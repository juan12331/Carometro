    ...
    return (
        <div>
                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white flex flex-col justify-between">
                    <ul className="space-y-2 font-medium">
                        <li className="flex flex-col">
                            ...
                            <select onChange={(e) => setTurma(e.target.value)} name="turma" id="turma" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                <option defaultValue disabled>Turma</option>
            ...
            <div className="p-4 sm:ml-64 mt-14">
                ...
                <div className="addStudent mb-5 w-full flex justify-between items-center">
                    <div className="turma text-lg">
                       {turma}
                    </div>
                    <a className="flex items-center max-w-max bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="/cadastro-aluno">
                        ...
                        <span className="ml-2">Adiconar Aluno</span>
                    </a>
                </div>
